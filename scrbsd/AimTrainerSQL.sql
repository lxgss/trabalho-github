...
-- 2. Tabela de Categorias (Ex: Gridshot, Tracking, Flicking)
CREATE TABLE Categories (
    ID_Cat INT PRIMARY KEY IDENTITY(1,1),
    Nome_Categoria VARCHAR(50) NOT NULL
);

-- 3. Tabela de Exercícios (Ligada às Categorias)
...
-- 4. Tabela de Rankings (A "ponte" que liga tudo: User + Exercicio + Pontos)
